...
<?php
        ...
        foreach ($this->rates as $rate)
        {
            ...
            <label for="shipping_<?php echo $rate['element']; ?>" onClick="j2storeSetShippingRate('<?php echo $rate['name']; ?>','<?php echo $rate['price']; ?>',<?php echo $rate['tax']; ?>,<?php echo $rate['extra']; ?>, '<?php echo $rate['code']; ?>', true );"><?php echo $rate['name']; ?> ( <?php echo $this->currency->format( $rate['total']); ?> )</label><br />
            <?php
        }
?>
<?php endif;?>
