...
<div id="j2store-checkout-content">
  <h1><?php echo JText::_('J2STORE_CHECKOUT'); ?></h1>
    ...
    <div id="checkout">
      ...
      <div class="checkout-content card-panel"></div>
    </div>
    <?php if (!$this->logged) { ?>
...
(function($) {
	$(document).ready(function() {
		// Style active heading
		window.setInterval(function () {
			$('.checkout-content[style!=block]').parent().find('.checkout-heading')
				.css({'background': '#F8F8F8', 'font-size': '0.9em'});

			$('.checkout-content[style*=block]').parent().find('.checkout-heading')
				.css({'background': '#fff', 'font-size': '1.3em'});
		}, 100);
