...
//we dont have a profile set in the store profile. So use the default one.
	$html = '<div class="row">
	<div class="col-sm-5">[first_name] [last_name] [email] [phone_1] [phone_2] [password] [confirm_password]</div>
	<div class="col-sm-5">[company] [tax_number] [address_1] [address_2] [city] [zip] [country_id] [zone_id]</div>
	</div>';
}
