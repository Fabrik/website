...
<div class="fabrikButtonsContainer row-fluid">
	...
	<?php if ($this->showAdd) : ?>
		...
		<a class="btn addbutton addRecord" href="<?php echo $this->addRecordLink; ?>">
	...
	if ($this->showFilters && $this->toggleFilters) :?>
		...
		<?php if ($this->filterMode === 5) :
			?>
			<a href="#filter_modal" class="btn modal-trigger" data-toggle="modal">
	...
	if ($this->showPDF) :?>
		<a href="<?php echo $this->pdfLink; ?>" class="pdfButton">
